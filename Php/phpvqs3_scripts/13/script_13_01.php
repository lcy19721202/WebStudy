...
<form action="test_pattern.php" method="post">
		<p>
			Regular Expression Pattern: <input type="text" name="pattern"
				value="<?php print $pattern; ?>" size="30" />
		</p>
		<p>
			Test String: <input type="text" name="string"
				value="<?php print $string; ?>" size="30" />
		</p>
