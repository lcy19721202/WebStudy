...
$mysqli = mysqli_connect ( "localhost", "joeuser", "somepass", "testDB" ) or die ( mysql_error () );
...
<body>
	<h1>Access Report</h1>
	<p>
		<strong>Total Accesses Tracked:</strong> <?php echo "$all_count"; ?></p>
	<p>
		<strong>Web Browsers Used:</strong> <?php echo "$user_agent_block"; ?></p>
	<p>
